...
/* === 38 CATEGORY TILES === */
var CAT=[
  {n:'Pneus, jantes et accessoires',href:'/search?type=product&q=pneus+jantes',bg:'#e3f2fd',svg:'<circle cx="20" cy="20" r="13" stroke="#1565c0" stroke-width="2.5" fill="none"/><circle cx="20" cy="20" r="5" stroke="#1565c0" stroke-width="2" fill="none"/><path d="M20 7L20 15M20 25L20 33M7 20L15 20M25 20L33 20" stroke="#1565c0" stroke-width="2" stroke-linecap="round"/>'},
  {n:'Huiles et fluides',href:'/collections/huiles-amp-lubrifiants',bg:'#fff8e1',svg:'<path d="M14 8L14 28Q14 34 20 34Q26 34 26 28L26 14L20 8Z" stroke="#f57f17" stroke-width="2.2" fill="none"/><path d="M26 14L30 14Q33 14 33 18Q33 22 29 22L26 22" stroke="#f57f17" stroke-width="2" fill="none"/>'},
  {n:'Frein',href:'/collections/freinage',bg:'#ffebee',svg:'<circle cx="20" cy="20" r="12" stroke="#c62828" stroke-width="2.5" fill="none"/><circle cx="20" cy="20" r="5" stroke="#c62828" stroke-width="2" fill="none"/><path d="M20 8L20 12M20 28L20 32M8 20L12 20M28 20L32 20" stroke="#c62828" stroke-width="2" stroke-linecap="round"/>'},
  {n:'Filtre',href:'/collections/filtration',bg:'#e8f5e9',svg:'<rect x="10" y="8" width="20" height="24" rx="4" stroke="#2e7d32" stroke-width="2.2" fill="none"/><line x1="10" y1="14" x2="30" y2="14" stroke="#2e7d32" stroke-width="1.8"/><line x1="10" y1="20" x2="30" y2="20" stroke="#2e7d32" stroke-width="1.8"/><line x1="10" y1="26" x2="30" y2="26" stroke="#2e7d32" stroke-width="1.8"/>'},
  {n:'Moteur',href:'/search?type=product&q=moteur+joint+culasse',bg:'#f3e5f5',svg:'<rect x="8" y="14" width="24" height="16" rx="2" stroke="#6a1b9a" stroke-width="2" fill="none"/><path d="M14 14L14 9M20 14L20 9M26 14L26 9" stroke="#6a1b9a" stroke-width="2.5" stroke-linecap="round"/>'},
  {n:"Systeme d'essuie-glaces",href:'/search?type=product&q=essuie-glace+balai',bg:'#e0f7fa',svg:'<path d="M8 30Q20 10 32 30" stroke="#00838f" stroke-width="2.5" fill="none"/><line x1="8" y1="30" x2="8" y2="34" stroke="#00838f" stroke-width="2.5" stroke-linecap="round"/>'},
  {n:'Allumage et prechauffage',href:'/search?type=product&q=bougie+allumage+prechauffage',bg:'#fffde7',svg:'<rect x="16" y="6" width="8" height="14" rx="3" stroke="#f9a825" stroke-width="2" fill="none"/><path d="M22 13L18 17L21 17L17 23" stroke="#f9a825" stroke-width="1.8" stroke-linecap="round"/>'},
  {n:'Suspension',href:'/collections/suspension-amp-direction',bg:'#fff3e0',svg:'<path d="M16 8L16 14L24 18L24 24L16 28L16 32" stroke="#e65100" stroke-width="2.2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'},
  {n:'Electricite',href:'/collections/electrique',bg:'#e8eaf6',svg:'<path d="M24 8L16 20L22 20L16 32" stroke="#283593" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>'},
  {n:'Amortissement',href:'/search?type=product&q=amortisseur',bg:'#e0f2f1',svg:'<rect x="17" y="5" width="6" height="14" rx="3" stroke="#00695c" stroke-width="2" fill="none"/><path d="M13 19L27 19L27 25L13 25Z" stroke="#00695c" stroke-width="2" fill="none"/><line x1="20" y1="25" x2="20" y2="35" stroke="#00695c" stroke-width="3" stroke-linecap="round"/>'},
  {n:"Recirculation des gaz d'echappement",href:'/search?type=product&q=egr+vanne+recirculation',bg:'#e8f5e9',svg:'<path d="M10 20Q10 10 20 10Q30 10 30 20" stroke="#1b5e20" stroke-width="2" fill="none"/><path d="M28 14L32 10L32 18" stroke="#1b5e20" stroke-width="2" fill="none"/>'},
  {n:'Courroies, chaines, galets',href:'/collections/moteur-amp-transmission',bg:'#fbe9e7',svg:'<path d="M10 14L30 14L30 26L10 26Z" stroke="#bf360c" stroke-width="2" fill="none"/><circle cx="14" cy="20" r="3" stroke="#bf360c" stroke-width="1.8" fill="none"/><circle cx="26" cy="20" r="3" stroke="#bf360c" stroke-width="1.8" fill="none"/>'},
  {n:'Composants pour la suralimentation',href:'/search?type=product&q=turbo+suralimentation',bg:'#e3f2fd',svg:'<circle cx="20" cy="20" r="10" stroke="#1565c0" stroke-width="2" fill="none"/><circle cx="20" cy="20" r="4" stroke="#1565c0" stroke-width="2" fill="none"/>'},
  {n:'Refroidissement moteur',href:'/search?type=product&q=radiateur+refroidissement+thermostat',bg:'#e0f7fa',svg:'<rect x="8" y="10" width="24" height="20" rx="2" stroke="#006064" stroke-width="2" fill="none"/><path d="M14 10L14 6M20 10L20 6M26 10L26 6" stroke="#006064" stroke-width="2" stroke-linecap="round"/>'},
  {n:'Carrosserie',href:'/collections/carrosserie',bg:'#fce4ec',svg:'<path d="M6 22L10 14Q14 8 20 8Q26 8 30 14L34 22L34 28L6 28Z" stroke="#880e4f" stroke-width="2" fill="none"/><circle cx="11" cy="28" r="3" stroke="#880e4f" stroke-width="1.8" fill="none"/><circle cx="29" cy="28" r="3" stroke="#880e4f" stroke-width="1.8" fill="none"/>'},
  {n:'Chauffage et ventilation',href:'/search?type=product&q=chauffage+ventilation+soufflante',bg:'#fff3e0',svg:'<circle cx="20" cy="20" r="8" stroke="#e65100" stroke-width="2" fill="none"/><path d="M20 12L20 8M20 28L20 32M12 20L8 20M28 20L32 20" stroke="#e65100" stroke-width="2" stroke-linecap="round"/>'},
  {n:"Joints et bagues d'etancheite",href:'/search?type=product&q=joint+etancheite',bg:'#f3e5f5',svg:'<circle cx="20" cy="20" r="12" stroke="#4a148c" stroke-width="2.5" fill="none"/><circle cx="20" cy="20" r="7" stroke="#4a148c" stroke-width="1.5" fill="none" stroke-dasharray="3,2"/>'},
  {n:'Echappement',href:'/search?type=product&q=echappement+pot+catalyseur',bg:'#e8eaf6',svg:'<path d="M6 22Q12 18 20 20Q28 22 34 18" stroke="#37474f" stroke-width="3" fill="none" stroke-linecap="round"/><circle cx="34" cy="18" r="4" stroke="#37474f" stroke-width="2" fill="none"/>'},
  {n:'Interieur',href:'/search?type=product&q=interieur+siege+tableau+bord',bg:'#fbe9e7',svg:'<path d="M8 28L8 18Q8 14 12 14L16 14Q18 10 20 10Q22 10 24 14L28 14Q32 14 32 18L32 28" stroke="#bf360c" stroke-width="2" fill="none"/>'},
  {n:"Systeme d'alimentation",href:'/search?type=product&q=injecteur+pompe+carburant',bg:'#fffde7',svg:'<rect x="12" y="8" width="16" height="22" rx="3" stroke="#f9a825" stroke-width="2" fill="none"/><path d="M28 14L32 14L32 22L28 22" stroke="#f9a825" stroke-width="2" fill="none"/>'},
  {n:'Direction',href:'/search?type=product&q=direction+cremaillere+rotule',bg:'#e8f5e9',svg:'<circle cx="20" cy="18" r="10" stroke="#1b5e20" stroke-width="2.5" fill="none"/><line x1="20" y1="28" x2="20" y2="34" stroke="#1b5e20" stroke-width="3" stroke-linecap="round"/>'},
  {n:'Embrayage',href:'/search?type=product&q=embrayage+disque+butee',bg:'#ffebee',svg:'<circle cx="20" cy="20" r="11" stroke="#c62828" stroke-width="2.2" fill="none"/><circle cx="20" cy="20" r="4" stroke="#c62828" stroke-width="2" fill="none"/><circle cx="20" cy="9" r="2" fill="#c62828"/><circle cx="28" cy="25" r="2" fill="#c62828"/><circle cx="12" cy="25" r="2" fill="#c62828"/>'},
  {n:'Cardan de transmission et joint homocinetique',href:'/search?type=product&q=cardan+transmission',bg:'#e0f2f1',svg:'<line x1="6" y1="20" x2="16" y2="20" stroke="#004d40" stroke-width="3" stroke-linecap="round"/><circle cx="20" cy="20" r="5" stroke="#004d40" stroke-width="2.2" fill="none"/><line x1="24" y1="20" x2="34" y2="20" stroke="#004d40" stroke-width="3" stroke-linecap="round"/>'},
  {n:'Suspension pneumatique',href:'/search?type=product&q=suspension+pneumatique',bg:'#e3f2fd',svg:'<rect x="14" y="10" width="12" height="20" rx="6" stroke="#1565c0" stroke-width="2.2" fill="none"/>'},
  {n:"Dispositif d'attelage / accessoires",href:'/search?type=product&q=attelage+remorque',bg:'#fff8e1',svg:'<path d="M6 22L28 22" stroke="#f57f17" stroke-width="3" stroke-linecap="round"/><circle cx="32" cy="22" r="4" stroke="#f57f17" stroke-width="2" fill="none"/>'},
  {n:'Boite de vitesse',href:'/search?type=product&q=boite+vitesse',bg:'#f3e5f5',svg:'<rect x="8" y="12" width="24" height="16" rx="3" stroke="#6a1b9a" stroke-width="2" fill="none"/><circle cx="14" cy="20" r="3" stroke="#6a1b9a" stroke-width="1.8" fill="none"/><circle cx="20" cy="20" r="3" stroke="#6a1b9a" stroke-width="1.8" fill="none"/><circle cx="26" cy="20" r="3" stroke="#6a1b9a" stroke-width="1.8" fill="none"/>'},
  {n:'Climatisation',href:'/search?type=product&q=climatisation+compresseur+condenseur',bg:'#e0f7fa',svg:'<rect x="8" y="12" width="24" height="16" rx="2" stroke="#006064" stroke-width="2" fill="none"/><path d="M14 15L26 25M14 25L26 15" stroke="#006064" stroke-width="1.5" stroke-linecap="round"/>'},
  {n:'Roulements',href:'/search?type=product&q=roulement+moyeu+roue',bg:'#e8eaf6',svg:'<circle cx="20" cy="20" r="12" stroke="#283593" stroke-width="2.2" fill="none"/><circle cx="20" cy="20" r="5" stroke="#283593" stroke-width="3" fill="none"/><circle cx="20" cy="8" r="2.5" fill="#283593"/><circle cx="20" cy="32" r="2.5" fill="#283593"/>'},
  {n:'Arbres de transmission et differentiels',href:'/search?type=product&q=arbre+transmission+differentiel',bg:'#fbe9e7',svg:'<line x1="6" y1="20" x2="34" y2="20" stroke="#bf360c" stroke-width="3" stroke-linecap="round"/><circle cx="12" cy="20" r="5" stroke="#bf360c" stroke-width="2" fill="none"/><circle cx="28" cy="20" r="5" stroke="#bf360c" stroke-width="2" fill="none"/>'},
  {n:'Capteurs, relais, unites de commande',href:'/collections/electrique',bg:'#e8f5e9',svg:'<rect x="10" y="12" width="20" height="16" rx="2" stroke="#1b5e20" stroke-width="2" fill="none"/><circle cx="16" cy="20" r="2" fill="#1b5e20"/><circle cx="24" cy="20" r="2" fill="#1b5e20"/>'},
  {n:'Accessoires voiture',href:'/search?type=product&q=accessoire+voiture',bg:'#fff3e0',svg:'<path d="M6 24L10 16Q14 10 20 10Q26 10 30 16L34 24L34 28L6 28Z" stroke="#e65100" stroke-width="2" fill="none"/>'},
  {n:'Kits de reparation',href:'/search?type=product&q=kit+reparation',bg:'#e3f2fd',svg:'<rect x="8" y="16" width="24" height="18" rx="2" stroke="#1565c0" stroke-width="2" fill="none"/><path d="M14 16L14 12Q14 8 20 8Q26 8 26 12L26 16" stroke="#1565c0" stroke-width="2" fill="none"/>'},
  {n:'Outillage et equipement',href:'/search?type=product&q=outillage',bg:'#ffebee',svg:'<path d="M10 30L24 16" stroke="#b71c1c" stroke-width="3" stroke-linecap="round"/><path d="M24 16Q28 10 32 10Q32 14 26 18" stroke="#b71c1c" stroke-width="2" fill="none" stroke-linecap="round"/>'},
  {n:'Tuyaux et conduites',href:'/search?type=product&q=tuyau+conduite+durite',bg:'#e0f2f1',svg:'<path d="M8 26Q8 14 16 14L24 14Q32 14 32 22" stroke="#004d40" stroke-width="3" fill="none" stroke-linecap="round"/>'},
  {n:"Produits de nettoyage et d'entretien",href:'/search?type=product&q=nettoyage+entretien',bg:'#e8eaf6',svg:'<path d="M16 8L16 22Q16 28 20 28Q24 28 24 22L24 8Z" stroke="#283593" stroke-width="2" fill="none"/><path d="M18 8L22 8" stroke="#283593" stroke-width="2.5" stroke-linecap="round"/>'},
  {n:'Eclairage',href:'/search?type=product&q=eclairage+feux+phare',bg:'#fffde7',svg:'<circle cx="20" cy="18" r="8" stroke="#f9a825" stroke-width="2" fill="none"/><path d="M20 6L20 4M20 30L20 32M8 18L6 18M32 18L34 18" stroke="#f9a825" stroke-width="2" stroke-linecap="round"/>'},
  {n:'Tuning',href:'/search?type=product&q=tuning+sport+performance',bg:'#fce4ec',svg:'<path d="M6 28L10 20Q14 12 22 10Q30 8 34 14Q32 22 26 24Q20 26 16 22Q12 26 6 28Z" stroke="#ad1457" stroke-width="2" fill="none"/>'},
  {n:'Fixations',href:'/search?type=product&q=fixation+vis+boulon',bg:'#f3e5f5',svg:'<line x1="20" y1="8" x2="20" y2="28" stroke="#4a148c" stroke-width="3" stroke-linecap="round"/><path d="M14 12L26 12" stroke="#4a148c" stroke-width="2.5" stroke-linecap="round"/>'}
];
